        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="{{ url('/update_service/' . $s->service_id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <h4><b>Ambulance Category</b></h4>
                        <select name="category">
                            <option value="">--Select--</option>
                            <option value="PREMIUM" @if($s->ambulance_category == "PREMIUM") selected @endif> Premium Service</option>
                            <option value="NON PREMIUM" @if($s->ambulance_category != "PREMIUM") selected @endif> Non Premium Service</option>
                        </select>

                        <br>
                        <h4><b>Service Name</b></h4>
                        <input type="text" name="sname" value="{{ $s->service_name }}" id="sname">
                        <br>
                        <h4><b>Service Charges/km</b></h4>
                        <input type="number" value="{{ $s->service_charge }}" name="scharge" id="scharge">
                        <br>
                        <h4><b>Service Images</b></h4>
                        <input type="file" name="simage">
                        <br><br>
                        <p><img style="width: 200px" src="{{ asset('Service_image/' . $s->service_image) }}"></p>

                        <h4><b>Service Details</b></h4>
                        <textarea name="sdetail" id="sdetail">{!! $s->service_details !!}</textarea>
                        <br><br>
